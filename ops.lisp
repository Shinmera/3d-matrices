...
(define-ofun mdet (m)
  (etypecase m
    (mat2 (- (* (%c2 0 0) (%c2 1 1))
             (* (%c2 0 1) (%c2 1 0))))
    (mat3 (- (+ (* (%c3 0 0) (%c3 1 1) (%c3 2 2))
                (* (%c3 0 1) (%c3 1 2) (%c3 2 0))
                (* (%c3 0 2) (%c3 1 0) (%c3 2 1)))
             (+ (* (%c3 0 0) (%c3 1 2) (%c3 2 1))
                (* (%c3 0 1) (%c3 1 0) (%c3 2 2))
                (* (%c3 0 2) (%c3 1 1) (%c3 2 0)))))
    (mat4 (- (+ (* (%c4 0 3) (%c4 1 2) (%c4 2 1) (%c4 3 0)) (* (%c4 0 0) (%c4 1 1) (%c4 2 2) (%c4 3 3))
                (* (%c4 0 1) (%c4 1 3) (%c4 2 2) (%c4 3 0)) (* (%c4 0 2) (%c4 1 1) (%c4 2 3) (%c4 3 0))
                (* (%c4 0 2) (%c4 1 3) (%c4 2 0) (%c4 3 1)) (* (%c4 0 3) (%c4 1 0) (%c4 2 2) (%c4 3 1))
                (* (%c4 0 0) (%c4 1 2) (%c4 2 3) (%c4 3 1)) (* (%c4 0 3) (%c4 1 1) (%c4 2 0) (%c4 3 2))
                (* (%c4 0 0) (%c4 1 3) (%c4 2 1) (%c4 3 2)) (* (%c4 0 1) (%c4 1 0) (%c4 2 3) (%c4 3 2))
                (* (%c4 0 1) (%c4 1 2) (%c4 2 0) (%c4 3 3)) (* (%c4 0 2) (%c4 1 0) (%c4 2 1) (%c4 3 3)))
             (+ (* (%c4 0 2) (%c4 1 3) (%c4 2 1) (%c4 3 0)) (* (%c4 0 3) (%c4 1 1) (%c4 2 2) (%c4 3 0))
                (* (%c4 0 1) (%c4 1 2) (%c4 2 3) (%c4 3 0)) (* (%c4 0 3) (%c4 1 2) (%c4 2 0) (%c4 3 1))
                (* (%c4 0 0) (%c4 1 3) (%c4 2 2) (%c4 3 1)) (* (%c4 0 2) (%c4 1 0) (%c4 2 3) (%c4 3 1))
                (* (%c4 0 1) (%c4 1 3) (%c4 2 0) (%c4 3 2)) (* (%c4 0 3) (%c4 1 0) (%c4 2 1) (%c4 3 2))
                (* (%c4 0 0) (%c4 1 1) (%c4 2 3) (%c4 3 2)) (* (%c4 0 2) (%c4 1 1) (%c4 2 0) (%c4 3 3))
                (* (%c4 0 0) (%c4 1 2) (%c4 2 1) (%c4 3 3)) (* (%c4 0 1) (%c4 1 0) (%c4 2 2) (%c4 3 3)))))
  ...
  (etypecase m
    (mat2 (let ((det (/ (mdet m))))
            (mat (* det (+ (%c2 1 1)))
                 ...
                 (* det (+ (%c2 0 0))))))
    (mat3 (let ((det (/ (mdet m))))
            (mat (* det (- (* (%c3 1 1) (%c3 2 2)) (* (%c3 1 2) (%c3 2 1))))
                 (* det (- (* (%c3 0 2) (%c3 2 1)) (* (%c3 0 1) (%c3 2 2))))
                 (* det (- (* (%c3 0 1) (%c3 1 2)) (* (%c3 0 2) (%c3 1 1))))
                 (* det (- (* (%c3 1 2) (%c3 2 0)) (* (%c3 1 0) (%c3 2 2))))
                 (* det (- (* (%c3 0 0) (%c3 2 2)) (* (%c3 0 2) (%c3 2 0))))
                 (* det (- (* (%c3 0 2) (%c3 1 0)) (* (%c3 0 0) (%c3 1 2))))
                 (* det (- (* (%c3 1 0) (%c3 2 1)) (* (%c3 1 1) (%c3 2 0))))
                 (* det (- (* (%c3 0 1) (%c3 2 0)) (* (%c3 0 0) (%c3 2 1))))
                 (* det (- (* (%c3 0 0) (%c3 1 1)) (* (%c3 0 1) (%c3 1 0)))))))
    (mat4 (let ((det (/ (mdet m))))
            (mat (* det (- (+ (* (%c4 1 2) (%c4 2 3) (%c4 3 1)) (* (%c4 1 3) (%c4 2 1) (%c4 3 2)) (* (%c4 1 1) (%c4 2 2) (%c4 3 3)))
                           (+ (* (%c4 1 3) (%c4 2 2) (%c4 3 1)) (* (%c4 1 1) (%c4 2 3) (%c4 3 2)) (* (%c4 1 2) (%c4 2 1) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 3) (%c4 2 2) (%c4 3 1)) (* (%c4 0 1) (%c4 2 3) (%c4 3 2)) (* (%c4 0 2) (%c4 2 1) (%c4 3 3)))
                           (+ (* (%c4 0 2) (%c4 2 3) (%c4 3 1)) (* (%c4 0 3) (%c4 2 1) (%c4 3 2)) (* (%c4 0 1) (%c4 2 2) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 2) (%c4 1 3) (%c4 3 1)) (* (%c4 0 3) (%c4 1 1) (%c4 3 2)) (* (%c4 0 1) (%c4 1 2) (%c4 3 3)))
                           (+ (* (%c4 0 3) (%c4 1 2) (%c4 3 1)) (* (%c4 0 1) (%c4 1 3) (%c4 3 2)) (* (%c4 0 2) (%c4 1 1) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 3) (%c4 1 2) (%c4 2 1)) (* (%c4 0 1) (%c4 1 3) (%c4 2 2)) (* (%c4 0 2) (%c4 1 1) (%c4 2 3)))
                           (+ (* (%c4 0 2) (%c4 1 3) (%c4 2 1)) (* (%c4 0 3) (%c4 1 1) (%c4 2 2)) (* (%c4 0 1) (%c4 1 2) (%c4 2 3)))))
                 (* det (- (+ (* (%c4 1 3) (%c4 2 2) (%c4 3 0)) (* (%c4 1 0) (%c4 2 3) (%c4 3 2)) (* (%c4 1 2) (%c4 2 0) (%c4 3 3)))
                           (+ (* (%c4 1 2) (%c4 2 3) (%c4 3 0)) (* (%c4 1 3) (%c4 2 0) (%c4 3 2)) (* (%c4 1 0) (%c4 2 2) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 2) (%c4 2 3) (%c4 3 0)) (* (%c4 0 3) (%c4 2 0) (%c4 3 2)) (* (%c4 0 0) (%c4 2 2) (%c4 3 3)))
                           (+ (* (%c4 0 3) (%c4 2 2) (%c4 3 0)) (* (%c4 0 0) (%c4 2 3) (%c4 3 2)) (* (%c4 0 2) (%c4 2 0) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 3) (%c4 1 2) (%c4 3 0)) (* (%c4 0 0) (%c4 1 3) (%c4 3 2)) (* (%c4 0 2) (%c4 1 0) (%c4 3 3)))
                           (+ (* (%c4 0 2) (%c4 1 3) (%c4 3 0)) (* (%c4 0 3) (%c4 1 0) (%c4 3 2)) (* (%c4 0 0) (%c4 1 2) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 2) (%c4 1 3) (%c4 2 0)) (* (%c4 0 3) (%c4 1 0) (%c4 2 2)) (* (%c4 0 0) (%c4 1 2) (%c4 2 3)))
                           (+ (* (%c4 0 3) (%c4 1 2) (%c4 2 0)) (* (%c4 0 0) (%c4 1 3) (%c4 2 2)) (* (%c4 0 2) (%c4 1 0) (%c4 2 3)))))
                 (* det (- (+ (* (%c4 1 1) (%c4 2 3) (%c4 3 0)) (* (%c4 1 3) (%c4 2 0) (%c4 3 1)) (* (%c4 1 0) (%c4 2 1) (%c4 3 3)))
                           (+ (* (%c4 1 3) (%c4 2 1) (%c4 3 0)) (* (%c4 1 0) (%c4 2 3) (%c4 3 1)) (* (%c4 1 1) (%c4 2 0) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 3) (%c4 2 1) (%c4 3 0)) (* (%c4 0 0) (%c4 2 3) (%c4 3 1)) (* (%c4 0 1) (%c4 2 0) (%c4 3 3)))
                           (+ (* (%c4 0 1) (%c4 2 3) (%c4 3 0)) (* (%c4 0 3) (%c4 2 0) (%c4 3 1)) (* (%c4 0 0) (%c4 2 1) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 1) (%c4 1 3) (%c4 3 0)) (* (%c4 0 3) (%c4 1 0) (%c4 3 1)) (* (%c4 0 0) (%c4 1 1) (%c4 3 3)))
                           (+ (* (%c4 0 3) (%c4 1 1) (%c4 3 0)) (* (%c4 0 0) (%c4 1 3) (%c4 3 1)) (* (%c4 0 1) (%c4 1 0) (%c4 3 3)))))
                 (* det (- (+ (* (%c4 0 3) (%c4 1 1) (%c4 2 0)) (* (%c4 0 0) (%c4 1 3) (%c4 2 1)) (* (%c4 0 1) (%c4 1 0) (%c4 2 3)))
                           (+ (* (%c4 0 1) (%c4 1 3) (%c4 2 0)) (* (%c4 0 3) (%c4 1 0) (%c4 2 1)) (* (%c4 0 0) (%c4 1 1) (%c4 2 3)))))
                 (* det (- (+ (* (%c4 1 2) (%c4 2 1) (%c4 3 0)) (* (%c4 1 0) (%c4 2 2) (%c4 3 1)) (* (%c4 1 1) (%c4 2 0) (%c4 3 2)))
                           (+ (* (%c4 1 1) (%c4 2 2) (%c4 3 0)) (* (%c4 1 2) (%c4 2 0) (%c4 3 1)) (* (%c4 1 0) (%c4 2 1) (%c4 3 2)))))
                 (* det (- (+ (* (%c4 0 1) (%c4 2 2) (%c4 3 0)) (* (%c4 0 2) (%c4 2 0) (%c4 3 1)) (* (%c4 0 0) (%c4 2 1) (%c4 3 2)))
                           (+ (* (%c4 0 2) (%c4 2 1) (%c4 3 0)) (* (%c4 0 0) (%c4 2 2) (%c4 3 1)) (* (%c4 0 1) (%c4 2 0) (%c4 3 2)))))
                 (* det (- (+ (* (%c4 0 2) (%c4 1 1) (%c4 3 0)) (* (%c4 0 0) (%c4 1 2) (%c4 3 1)) (* (%c4 0 1) (%c4 1 0) (%c4 3 2)))
                           (+ (* (%c4 0 1) (%c4 1 2) (%c4 3 0)) (* (%c4 0 2) (%c4 1 0) (%c4 3 1)) (* (%c4 0 0) (%c4 1 1) (%c4 3 2)))))
                 (* det (- (+ (* (%c4 0 1) (%c4 1 2) (%c4 2 0)) (* (%c4 0 2) (%c4 1 0) (%c4 2 1)) (* (%c4 0 0) (%c4 1 1) (%c4 2 2)))
                           (+ (* (%c4 0 2) (%c4 1 1) (%c4 2 0)) (* (%c4 0 0) (%c4 1 2) (%c4 2 1)) (* (%c4 0 1) (%c4 1 0) (%c4 2 2))))))))
    (matn (let ((det (/ (mdet m))))
            (nm* (madj m) det)))))
...
(define-ofun mtranspose (m)
  (etypecase m
    (mat2 (mat (%c2 0 0) (%c2 1 0)
               (%c2 0 1) (%c2 1 1)))
    (mat3 (mat (%c3 0 0) (%c3 1 0) (%c3 2 0)
               (%c3 0 1) (%c3 1 1) (%c3 2 1)
               (%c3 0 2) (%c3 1 2) (%c3 2 2)))
    (mat4 (mat (%c4 0 0) (%c4 1 0) (%c4 2 0) (%c4 3 0)
               (%c4 0 1) (%c4 1 1) (%c4 2 1) (%c4 3 1)
               (%c4 0 2) (%c4 1 2) (%c4 2 2) (%c4 3 2)
               (%c4 0 3) (%c4 1 3) (%c4 2 3) (%c4 3 3)))
...
(define-ofun mtrace (m)
  (etypecase m
    (mat2 (+ (%c2 0 0) (%c2 1 1)))
    (mat3 (+ (%c3 0 0) (%c3 1 1) (%c3 2 2)))
    (mat4 (+ (%c4 0 0) (%c4 1 1) (%c4 2 2) (%c4 3 3)))
...
(define-ofun madj (m)
  ...
  (etypecase m
    ...
    (mat3 (mat (- (* (%c3 1 1) (%c3 2 2))
               ...
               (- (* (%c3 0 0) (%c3 1 1))
                  (* (%c3 0 1) (%c3 1 0)))))
    (mat4 (mat (- (+ (* (%c4 1 1) (%c4 2 2) (%c4 3 3)) (* (%c4 1 2) (%c4 2 3) (%c4 3 1)) (* (%c4 1 3) (%c4 2 1) (%c4 3 2)))
                  (+ (* (%c4 1 1) (%c4 2 3) (%c4 3 2)) (* (%c4 1 2) (%c4 2 1) (%c4 3 3)) (* (%c4 1 3) (%c4 2 2) (%c4 3 1))))
               (- (+ (* (%c4 0 1) (%c4 2 3) (%c4 3 2)) (* (%c4 0 2) (%c4 2 1) (%c4 3 3)) (* (%c4 0 3) (%c4 2 2) (%c4 3 1)))
                  (+ (* (%c4 0 2) (%c4 2 3) (%c4 3 1)) (* (%c4 0 3) (%c4 2 1) (%c4 3 2)) (* (%c4 0 1) (%c4 2 2) (%c4 3 3))))
               (- (+ (* (%c4 0 1) (%c4 1 2) (%c4 3 3)) (* (%c4 0 2) (%c4 1 3) (%c4 3 1)) (* (%c4 0 3) (%c4 1 1) (%c4 3 2)))
                  (+ (* (%c4 0 1) (%c4 1 3) (%c4 3 2)) (* (%c4 0 2) (%c4 1 1) (%c4 3 3)) (* (%c4 0 3) (%c4 1 2) (%c4 3 1))))
               (- (+ (* (%c4 0 1) (%c4 1 3) (%c4 2 2)) (* (%c4 0 2) (%c4 1 1) (%c4 2 3)) (* (%c4 0 3) (%c4 1 2) (%c4 2 1)))
                  (+ (* (%c4 0 2) (%c4 1 3) (%c4 2 1)) (* (%c4 0 3) (%c4 1 1) (%c4 2 2)) (* (%c4 0 1) (%c4 1 2) (%c4 2 3))))
               (- (+ (* (%c4 1 0) (%c4 2 3) (%c4 3 2)) (* (%c4 1 2) (%c4 2 0) (%c4 3 3)) (* (%c4 1 3) (%c4 2 2) (%c4 3 0)))
                  (+ (* (%c4 1 2) (%c4 2 3) (%c4 3 0)) (* (%c4 1 3) (%c4 2 0) (%c4 3 2)) (* (%c4 1 0) (%c4 2 2) (%c4 3 3))))
               (- (+ (* (%c4 0 0) (%c4 2 2) (%c4 3 3)) (* (%c4 0 3) (%c4 2 0) (%c4 3 2)) (* (%c4 0 2) (%c4 2 3) (%c4 3 0)))
                  (+ (* (%c4 0 0) (%c4 2 3) (%c4 3 2)) (* (%c4 0 2) (%c4 2 0) (%c4 3 3)) (* (%c4 0 3) (%c4 2 2) (%c4 3 0))))
               (- (+ (* (%c4 0 0) (%c4 1 3) (%c4 3 2)) (* (%c4 0 3) (%c4 1 2) (%c4 3 0)) (* (%c4 0 2) (%c4 1 0) (%c4 3 3)))
                  (+ (* (%c4 0 2) (%c4 1 3) (%c4 3 0)) (* (%c4 0 3) (%c4 1 0) (%c4 3 2)) (* (%c4 0 0) (%c4 1 2) (%c4 3 3))))
               (- (+ (* (%c4 0 0) (%c4 1 2) (%c4 2 3)) (* (%c4 0 3) (%c4 1 0) (%c4 2 2)) (* (%c4 0 2) (%c4 1 3) (%c4 2 0)))
                  (+ (* (%c4 0 0) (%c4 1 3) (%c4 2 2)) (* (%c4 0 2) (%c4 1 0) (%c4 2 3)) (* (%c4 0 3) (%c4 1 2) (%c4 2 0))))
               (- (+ (* (%c4 1 0) (%c4 2 1) (%c4 3 3)) (* (%c4 1 3) (%c4 2 0) (%c4 3 1)) (* (%c4 1 1) (%c4 2 3) (%c4 3 0)))
                  (+ (* (%c4 1 0) (%c4 2 3) (%c4 3 1)) (* (%c4 1 1) (%c4 2 0) (%c4 3 3)) (* (%c4 1 3) (%c4 2 1) (%c4 3 0))))
               (- (+ (* (%c4 0 0) (%c4 2 3) (%c4 3 1)) (* (%c4 0 3) (%c4 2 1) (%c4 3 0)) (* (%c4 0 1) (%c4 2 0) (%c4 3 3)))
                  (+ (* (%c4 0 1) (%c4 2 3) (%c4 3 0)) (* (%c4 0 3) (%c4 2 0) (%c4 3 1)) (* (%c4 0 0) (%c4 2 1) (%c4 3 3))))
               (- (+ (* (%c4 0 0) (%c4 1 1) (%c4 3 3)) (* (%c4 0 3) (%c4 1 0) (%c4 3 1)) (* (%c4 0 1) (%c4 1 3) (%c4 3 0)))
                  (+ (* (%c4 0 0) (%c4 1 3) (%c4 3 1)) (* (%c4 0 1) (%c4 1 0) (%c4 3 3)) (* (%c4 0 3) (%c4 1 1) (%c4 3 0))))
               (- (+ (* (%c4 0 0) (%c4 1 3) (%c4 2 1)) (* (%c4 0 3) (%c4 1 1) (%c4 2 0)) (* (%c4 0 1) (%c4 1 0) (%c4 2 3)))
                  (+ (* (%c4 0 1) (%c4 1 3) (%c4 2 0)) (* (%c4 0 3) (%c4 1 0) (%c4 2 1)) (* (%c4 0 0) (%c4 1 1) (%c4 2 3))))
               (- (+ (* (%c4 1 0) (%c4 2 2) (%c4 3 1)) (* (%c4 1 2) (%c4 2 1) (%c4 3 0)) (* (%c4 1 1) (%c4 2 0) (%c4 3 2)))
                  (+ (* (%c4 1 1) (%c4 2 2) (%c4 3 0)) (* (%c4 1 2) (%c4 2 0) (%c4 3 1)) (* (%c4 1 0) (%c4 2 1) (%c4 3 2))))
               (- (+ (* (%c4 0 0) (%c4 2 1) (%c4 3 2)) (* (%c4 0 2) (%c4 2 0) (%c4 3 1)) (* (%c4 0 1) (%c4 2 2) (%c4 3 0)))
                  (+ (* (%c4 0 0) (%c4 2 2) (%c4 3 1)) (* (%c4 0 1) (%c4 2 0) (%c4 3 2)) (* (%c4 0 2) (%c4 2 1) (%c4 3 0))))
               (- (+ (* (%c4 0 0) (%c4 1 2) (%c4 3 1)) (* (%c4 0 2) (%c4 1 1) (%c4 3 0)) (* (%c4 0 1) (%c4 1 0) (%c4 3 2)))
                  (+ (* (%c4 0 1) (%c4 1 2) (%c4 3 0)) (* (%c4 0 2) (%c4 1 0) (%c4 3 1)) (* (%c4 0 0) (%c4 1 1) (%c4 3 2))))
               (- (+ (* (%c4 0 0) (%c4 1 1) (%c4 2 2)) (* (%c4 0 2) (%c4 1 0) (%c4 2 1)) (* (%c4 0 1) (%c4 1 2) (%c4 2 0)))
                  (+ (* (%c4 0 0) (%c4 1 2) (%c4 2 1)) (* (%c4 0 1) (%c4 1 0) (%c4 2 2)) (* (%c4 0 2) (%c4 1 1) (%c4 2 0))))))
    (matn
     (mtranspose (mcof m)))))
